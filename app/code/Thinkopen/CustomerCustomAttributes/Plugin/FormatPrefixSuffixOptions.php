...
namespace Thinkopen\CustomerCustomAttributes\Plugin;
...
{
    /**
     * @var \Thinkopen\CustomerCustomAttributes\Model\Options
     */
    private $options;

    /**
     * @param \Thinkopen\CustomerCustomAttributes\Model\Options $options
     */
    public function __construct(
        \Thinkopen\CustomerCustomAttributes\Model\Options $options
    ) {

...
use Thinkopen\CustomerCustomAttributes\Controller\Adminhtml\Customer\Attribute;
use Magento\Framework\Serialize\Serializer\FormData;
use Magento\Customer\Model\AttributeFactory;
use Thinkopen\CustomerCustomAttributes\Helper\Customer as HelperCustomer;
use Thinkopen\CustomerCustomAttributes\Helper\Data as HelperData;
        ...
        if ($this->getRequest()->isPost() && $data) {
            ...
            try {
                $this->_eventManager->dispatch(
                    'thinkopen_customercustomattributes_attribute_before_save',
                    ['attribute' => $attributeObject]
                );
                $attributeObject->save();
                $this->_eventManager->dispatch(
                    'thinkopen_customercustomattributes_attribute_save',
                    ['attribute' => $attributeObject]
                );

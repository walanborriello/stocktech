 ...
 * @author Paolo
 */
namespace Thinkopen\CustomerCustomAttributes\Controller\Adminhtml\Customer\Address;
...
abstract class Attribute extends \Magento\Backend\App\Action
{
     ...
     * @see _isAllowed()
     */
    const ADMIN_RESOURCE = 'Thinkopen_CustomerCustomAttributes::customer_address_attributes';
    ...
    protected function _initAction()
    {
        ...
        $this->_setActiveMenu(
            'Thinkopen_CustomerCustomAttributes::customer_attributes_customer_address_attributes'
        )->_addBreadcrumb(
            __('Customer'),
            __('Customer')
        )->_addBreadcrumb(

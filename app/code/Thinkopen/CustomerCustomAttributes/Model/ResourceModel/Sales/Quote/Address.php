 ...
 * @author Paolo
 */
namespace Thinkopen\CustomerCustomAttributes\Model\ResourceModel\Sales\Quote;

/**
 * Customer Quote Address resource model
 */
class Address extends \Thinkopen\CustomerCustomAttributes\Model\ResourceModel\Sales\Address\AbstractAddress
{
    /**
    ...
    {
        $this->_init('thinkopen_customercustomattributes_sales_flat_quote_address', 'entity_id');
    }

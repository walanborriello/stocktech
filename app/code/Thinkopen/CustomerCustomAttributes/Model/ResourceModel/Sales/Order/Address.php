 ...
 * @author Paolo
 */
namespace Thinkopen\CustomerCustomAttributes\Model\ResourceModel\Sales\Order;
...
class Address extends \Thinkopen\CustomerCustomAttributes\Model\ResourceModel\Sales\Address\AbstractAddress
{
    ...
    {
        $this->_init('thinkopen_customercustomattributes_sales_flat_order_address', 'entity_id');
    }

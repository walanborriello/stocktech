 ...
 * @author Paolo
 */
namespace Thinkopen\CustomerCustomAttributes\Model\ResourceModel\Sales;
...
abstract class AbstractSales extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
     ...
     *
     * @param \Thinkopen\CustomerCustomAttributes\Model\Sales\AbstractSales $sales
     * @return bool
     */
    public function isEntityExists(\Thinkopen\CustomerCustomAttributes\Model\Sales\AbstractSales $sales)
    {
        if (!$sales->getId()) {
            return false;
        }

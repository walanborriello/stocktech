<?php
namespace Thinkopen\CustomerCustomAttributes\Block\Adminhtml\Customer\Address\Attribute\Edit\Tab;
    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $this->_eventManager->dispatch(
            'thinkopen_customercustomattributes_address_attribute_edit_tab_general_prepare_form',
